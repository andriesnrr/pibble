...
export default function PibbleLanding() {
  ...
  const steps = [
    {
      ...
      title: "Daftar Akun",
      description:
        "Buat akun dengan mudah menggunakan email atau nomor telepon",
    ...
    },
    {
      ...
      title: "Pilih Layanan",
      description:
        "Pilih jenis layanan yang Anda butuhkan untuk hewan peliharaan",
  ...
  const teamMembers = [
    {
      name: "Andries Nauvalentin Roestam",
      role: "Web Developer",
      avatar: "👨‍💻",
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Pibble adalah aplikasi yang menjembatani pemilik hewan peliharaan dengan penyedia layanan dan jasa perawatan hewan. Seperti yang dialami Keysha, kami hadir untuk mengatasi masalah antrian panjang dan transparansi harga yang tidak jelas.",
    },
    {
      question: "Layanan apa saja yang tersedia di Pibble?",
      answer:
        "Pibble menyediakan berbagai layanan seperti Pet Clinic, Pet Shop, Pet Adoption, Pet Hotel, dan Pet Grooming. Semua terintegrasi dalam satu platform untuk kemudahan Anda.",
    },
    {
      question: "Bagaimana sistem pembayaran di Pibble?",
      answer:
        "Pibble menggunakan sistem Online Payments yang aman dan transparan. Anda dapat melihat harga layanan dengan jelas sebelum melakukan booking, tidak ada biaya tersembunyi.",
    },
    {
      question: "Apakah ada sistem reward untuk pengguna?",
      answer:
        "Ya! Pibble memiliki Rewarding System dimana Anda dapat mengumpulkan poin setiap menggunakan layanan dan menukarkannya dengan berbagai keuntungan.",
    },
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1MukAF-YrAFoez7oxcgtljKGxu1e_huVj/view?usp=sharing",
                    "_blank"
                  )
                }
              >
  ...
  onClick={() => {
    window.open('https://drive.google.com/file/d/1MukAF-YrAFoez7oxcgtljKGxu1e_huVj/view?usp=sharing', '_blank');
...
>
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            >
              ...
              >
                Solusi untuk mengatasi antrian panjang dan transparansi harga
                yang tidak jelas. Aplikasi yang menjembatani pemilik hewan
                peliharaan dengan penyedia layanan perawatan hewan.
              </motion.p>
              <motion.div
                initial={{ y: 30, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
  ...
  size="lg"
  className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
  onClick={() => window.open('https://drive.google.com/file/d/1MukAF-YrAFoez7oxcgtljKGxu1e_huVj/view?usp=sharing', '_blank')}
>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  <strong>Keysha</strong>, seorang pemilik hewan peliharaan,
                  mengalami kesulitan saat pertama kali pergi ke klinik hewan.
                  Dia merasa capek karena harus mengantri karena disaat itu
                  klinik memang sedang padat jadwalnya.
                </p>
                <p>
                  Ketika tiba saat pembayaran layanan/jasa, dia terkejut dengan
                  harga yang tidak terduga tingginya, karena tidak adanya
                  transparansi yang jelas mengenai harga.
                </p>
              </div>
      ...
      <section id="how-it-works" className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Proses yang sederhana dan cepat untuk memberikan perawatan terbaik
              ...
              {steps.map((step, index: number) => (
                ...
                >
                  ...
                  <div className="relative z-10 text-center group">
                    ...
                    {/* Icon */}
                    <div
                      className={`w-20 h-20 ${step.color} rounded-2xl flex items-center justify-center text-white mx-auto mb-6 group-hover:scale-105 transition-transform`}
                    >
                      {step.icon}
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-100 to-purple-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Lihat tampilan aplikasi mobile PIBBLE yang user-friendly dan
              feature-rich
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto mb-20">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  <strong>Dashboard yang Intuitif</strong> - Kelola semua
                  aktivitas hewan peliharaan Anda dalam satu tampilan yang mudah
                  dipahami.
                </p>
                <p>
                  <strong>Member System</strong> - Sistem keanggotaan yang
                  memberikan berbagai keuntungan dan akses eksklusif untuk
                  layanan premium.
                </p>
                  ...
                  <div className="w-full h-full bg-gradient-to-b from-gray-50 to-white rounded-[2rem] p-4 relative overflow-hidden">
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="bg-gradient-to-r from-orange-100 to-orange-200 rounded-xl p-4">
                        <div className="flex items-center space-x-3">
                          <div className="w-12 h-12 bg-orange-300 rounded-full flex items-center justify-center text-lg">
                            🐱
                          </div>
                          <div>
                      ...
                      <div className="bg-gradient-to-r from-pink-100 to-pink-200 rounded-xl p-4">
                        <div className="flex items-center space-x-3">
                          <div className="w-12 h-12 bg-pink-300 rounded-full flex items-center justify-center text-lg">
                            🐶
                          </div>
                          <div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-gray-50 rounded-lg p-3">
                        ...
                        <p className="text-xs text-gray-600">
                          Dapatkan point setiap transaksi
                        </p>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-sm font-medium text-gray-900">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto mb-20">
                  ...
                  <div className="w-full h-full bg-gradient-to-b from-blue-50 to-white rounded-[2rem] p-4 relative overflow-hidden">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="bg-green-400 text-white text-xs px-2 py-1 rounded">
                          Tukar
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="bg-purple-400 text-white text-xs px-2 py-1 rounded">
                          Tukar
                        </div>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  <strong>Reward System yang Menguntungkan</strong> - Dapatkan
                  reward yang akan diberikan oleh Pibble dengan cara menggunakan
                  layanan yang disediakan.
                </p>
                <p>
                  <strong>Layanan Lengkap</strong> - Akses berbagai layanan
                  perawatan hewan dalam satu aplikasi yang mudah digunakan.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  <strong>Pengelolaan Vaksin Terpadu</strong> - Mencapai yang
                  tidak diinginkan lebih awal dengan pengingat vaksin dan jadwal
                  kesehatan.
                </p>
                <p>
                  <strong>Checkup Berkala</strong> - Pantau kesehatan hewan
                  peliharaan Anda secara rutin dengan sistem reminder otomatis.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex space-x-3">
                        <div className="bg-blue-100 rounded-lg p-3 text-center flex-1">
                          <div className="w-8 h-8 bg-blue-500 rounded-full mx-auto mb-1 flex items-center justify-center text-white">
                            🐱
                          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Tim developer dan designer berpengalaman yang membangun aplikasi
              Pibble
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Bergabunglah dengan revolusi perawatan hewan peliharaan. Tidak
                ada lagi antrian panjang dan harga mengejutkan. Semua transparan
                dan mudah di PIBBLE!
              </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Platform Pet Care and Health Service App yang menjembatani
                pemilik hewan peliharaan dengan penyedia layanan perawatan
                hewan. Solusi untuk antrian panjang dan transparansi harga.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-lg font-semibold mb-2">
                  Stay Updated with PIBBLE
                </h3>
                <p className="text-gray-400">
                  Dapatkan update terbaru tentang fitur dan layanan PIBBLE untuk
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex flex-col md:flex-row gap-4 text-gray-400 text-sm">
                <p>
                  © 2025 PIBBLE. All rights reserved. Pet Care and Health
                  Service App.
                </p>
                <div className="flex gap-4">
                  <a href="#" className="hover:text-white transition-colors">
